...
class CustomAlertViewController: UIViewController {
    ...
    private let messageLabel = CFBodyLabel(textAlignment: .center, fontSize: 18)
    private let actionButton = CFButton(backgroundColor: .systemPink, title: "Ok")
    ...
    func configureMessageLabel() {
        ...
        messageLabel.text = message ?? "Unable to compelete request"
